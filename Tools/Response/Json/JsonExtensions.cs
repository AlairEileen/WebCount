...
namespace Tools.Response.Json
{
    ...
    public static class JsonExtensions
    {
        ...
        {
            return controller.JsonSuccess(new JsonResponse1<object> { JsonData = obj });
        }

        public static string ToJson(this object obj, string[] paramArray)
        {
            JsonSerializerSettings settings;

            settings = new JsonSerializerSettings() { ContractResolver = new LimitPropsContractResolver(paramArray) };
